...
// Start the session
    ...
    $products = $conn->query("SELECT id, nameBG, imagePath, shortDescriptionBG, longDescriptionBG, price, categoryID FROM products ORDER BY id DESC LIMIT 5")->fetch_all(MYSQLI_ASSOC);
