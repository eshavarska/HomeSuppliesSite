...
// Start the session
    ...
    $products = $conn->query("SELECT id, nameBG, imagePath, shortDescriptionBG, longDescriptionBG, price, categoryID FROM products WHERE isPromo=1 ORDER BY RAND() LIMIT 5")->fetch_all(MYSQLI_ASSOC);
