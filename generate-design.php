...
require ("db-data.php");
     ...
     $dictionaryBG["Delivery"] = "ДОСТАВКА";
     ...
     $dictionaryEN["Delivery"] = "DELIVERY";
...
function generateCategoriesMenu() {
    ...
    foreach ($categories as &$category) {
        echo  '<li id="category'.$category["id"].'"><a style="color: #f1ddcf" href="category.php?id='.$category["id"].' "><span  aria-hidden="true"></span> '.$category["name"].' </a></li>';
    }
...
function generateNavBar() {
    ...
    echo <<<navBar
            ...
            <head>
                <title> Домашни потреби MyHo.me</title>
...
function generateNavBarRight () {
    ...
    if ($_SESSION["userID"] == "") {
        ...
        echo <<<navBarRight
                                ...
                                <li><a style="color:#c9f15a" href="blog.php"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> $dictionary[Blog]</a></li>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-left">
                                ...
                                <li><a style="color: #f1ddcf" href="delivery.php"><span class="glyphicon glyphicon-plane" aria-hidden="true"></span> $dictionary[Delivery]</a></li>
                            </ul>
                             ...
                             <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a style="color: #f1ddcf" href="map.php"><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span> $dictionary[Map]</a></li>
                            </ul>
                        </div>
